...
<aside class="admin-sidebar">
  ...
  <a href="<?= SITE_URL ?>/admin/settings.php" class="admin-menu-item <?= $ap==='settings'?'active':'' ?>"><span class="menu-icon">⚙️</span><span>Liga Einstellungen</span></a>
  <a href="<?= SITE_URL ?>/admin/design.php" class="admin-menu-item <?= $ap==='design'?'active':'' ?>"><span class="menu-icon">🎨</span><span>Design</span></a>
  <a href="<?= SITE_URL ?>/admin/info.php" class="admin-menu-item <?= $ap==='info'?'active':'' ?>"><span class="menu-icon">ℹ️</span><span>Liga Info</span></a>
  <a href="<?= SITE_URL ?>/admin/social.php" class="admin-menu-item <?= $ap==='social'?'active':'' ?>"><span class="menu-icon">🔗</span><span>Social Links</span></a>
  ...
  <a href="<?= SITE_URL ?>/admin/seasons.php" class="admin-menu-item <?= $ap==='seasons'?'active':'' ?>"><span class="menu-icon">🏆</span><span>Saisons</span></a>
  ...
  <a href="<?= SITE_URL ?>/admin/teams.php" class="admin-menu-item <?= $ap==='teams'?'active':'' ?>"><span class="menu-icon">🚗</span><span>Teams</span></a>
  <a href="<?= SITE_URL ?>/admin/drivers.php" class="admin-menu-item <?= $ap==='drivers'?'active':'' ?>"><span class="menu-icon">🏎️</span><span>Fahrer (Global)</span></a>
  <a href="<?= SITE_URL ?>/admin/lineup.php" class="admin-menu-item <?= $ap==='lineup'?'active':'' ?>"><span class="menu-icon">📋</span><span>Saison-Lineup</span></a>
  <div class="admin-menu-group">Rennen</div>
  <a href="<?= SITE_URL ?>/admin/results.php" class="admin-menu-item <?= $ap==='results'?'active':'' ?>"><span class="menu-icon">🏁</span><span>Race Results</span></a>
  ...
  <a href="<?= SITE_URL ?>/admin/import_lmu.php" class="admin-menu-item <?= $ap==='import_lmu'?'active':'' ?>"><span class="menu-icon">🏎</span><span>LMU XML Import</span></a>
  <a href="<?= SITE_URL ?>/admin/export.php" class="admin-menu-item <?= $ap==='export'?'active':'' ?>"><span class="menu-icon">🖼</span><span>Grafik Export</span></a>
  ...
  <a href="<?= SITE_URL ?>/admin/points.php" class="admin-menu-item <?= $ap==='points'?'active':'' ?>"><span class="menu-icon">🏅</span><span>Punktesystem</span></a>
  <div class="admin-menu-group">System</div>
  <a href="<?= SITE_URL ?>/admin/users.php" class="admin-menu-item <?= $ap==='users'?'active':'' ?>"><span class="menu-icon">👤</span><span>Benutzer</span></a>
  <a href="<?= SITE_URL ?>/admin/advanced.php" class="admin-menu-item <?= $ap==='advanced'?'active':'' ?>"><span class="menu-icon">🔧</span><span>Erweitert</span></a>
</aside>
