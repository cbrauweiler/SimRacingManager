...
// Offizielle SVG Icons für Social Media
$socialSvgs = [
    'twitter' => '<svg viewBox="0 0 24 24" fill="currentColor" width="18" height="18"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-4.714-6.231-5.401 6.231H2.744l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>',
    ...
    'other' => '<svg viewBox="0 0 24 24" fill="currentColor" width="18" height="18"><path d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14"/></svg>',
];
?>
</main>
...
<footer id="main-footer">
  <div class="container footer-inner">
    <div class="footer-brand">
      <div class="footer-league-name"><?= h($leagueName) ?></div>
      <div class="footer-league-abbr"><?= h($leagueAbbr) ?></div>
      <?php if($leagueDesc): ?><p class="footer-desc"><?= h($leagueDesc) ?></p><?php endif; ?>
      <?php if($socialLinks): ?>
      <div class="social-links" style="margin-top:16px">
        <?php foreach($socialLinks as $sl):
          $icon = $socialSvgs[$sl['platform']] ?? $socialSvgs['other'];
          $label = ucfirst($sl['platform']);
          // Spezialfarben pro Plattform
          $colors = [
            'twitter'   => '#000000',
            'instagram' => '#E1306C',
            'youtube'   => '#FF0000',
          ...
          $bg = $colors[$sl['platform']] ?? 'var(--primary)';
        ?>
        <a href="<?= h($sl['url']) ?>"
           class="social-link"
           target="_blank"
