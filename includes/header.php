...
<?php if(getSetting('fonts_local','0')==='1' && (file_exists(__DIR__.'/../assets/fonts/BarlowCondensed-Black.woff2') || file_exists(__DIR__.'/../assets/fonts/BarlowCondensed-Black.ttf'))): ?>
